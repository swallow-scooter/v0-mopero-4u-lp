...
const faqs = [
  ...
  {
    question: "バッテリーは追加で購入できますか？",
    answer:
      "はい、予備バッテリーを別途ご購入いただけます。長距離の移動や充電時間を短縮したい方におすすめです。詳しくはカスタマーサポートまでお問い合わせください。",
  },
  {
  ...
  },
  {
    question: "体重制限はありますか？",
    answer:
      "最大荷重は125kgです。高耐久のスチールフレームとハイパワーモーターにより、幅広い体格の方にご利用いただけます。",
  },
  {
    question: "家族で共有できますか？",
    answer:
